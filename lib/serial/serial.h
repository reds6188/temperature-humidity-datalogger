...
class Uart {
    ...
    public:
        ...
        void printHexData(uint8_t *data, int data_size);
        void printRawData(uint8_t *data, int data_size);
        String getRawString(uint8_t *data, int data_size);
};
